...
function getStrength(pw) {
  ...
  const map = [
    null,
    { label: "Weak",   color: "oklch(0.65 0.22 30)"  },
    { label: "Fair",   color: "oklch(0.72 0.18 80)"  },
    { label: "Good",   color: "oklch(0.70 0.20 145)" },
          ...
          <div className="relative">
            ...
            <div className="mb-8">
              ...
              <p style={{ fontSize: "0.82rem", lineHeight: 1.65, color: C.muted }}>
                Join 10,000+ students across India who use ShikshaSetu to make confident academic and career decisions.
              </p>
            </div>
        ...
        <div className="flex-1 p-8 md:p-10 flex flex-col justify-center">
          ...
          <div className="mb-7">
            ...
            <p style={{ fontSize: "0.85rem", color: C.muted }}>
              Get personalised guidance in under 5 minutes.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="name" style={{ fontSize: "0.8rem", fontWeight: 600, color: "oklch(0.72 0.04 275)" }}>
                Full Name
              </Label>
              <Input
                id="name"
                  ...
                  <div className="flex gap-1.5">
                    {[1, 2, 3, 4].map((s) => (
                      <div
                        ...
                        style={{
                          height: 3,
                          background: s <= strength.score ? strength.color : C.border,
                        }}
                      />
                    ))}
                  </div>
            ...
            {/* Terms note */}
            <p style={{ fontSize: "0.74rem", color: C.mutedLo, lineHeight: 1.5 }}>
              By creating an account you agree to our{" "}
              <span style={{ color: C.primary, cursor: "pointer" }}>Terms of Service</span>{" "}
              and{" "}
